...
class ImplementationTest {
    ...
    void testCustomSelectorWithParamsNoCache () {
        var named003_std = Implementation.ofNew (NamedService003.class, new CustomSelector (), new StdCustParams ("s"));
        assertTrue (named003_std.isPresent ());
        assertTrue (named003_std.get ().getClass ().getName ().endsWith ("Standard"));
        var named003_std_clone = Implementation.of (NamedService003.class, new CustomSelector (), new StdCustParams ("s"));
        assertNotSame (named003_std.get (), named003_std_clone.get ());
        
        var named003_cus = Implementation.ofNew (NamedService003.class, new CustomSelector (), new StdCustParams ("c"));
        assertTrue (named003_cus.isPresent ());
        assertTrue (named003_cus.get ().getClass ().getName ().endsWith ("Custom"));
        var named003_cus_clone = Implementation.of (NamedService003.class, new CustomSelector (), new StdCustParams ("c"));
        assertNotSame (named003_cus.get (), named003_cus_clone.get ());
        
        var named003_no = Implementation.ofNew (NamedService003.class, new CustomSelector (), new StdCustParams ("asd"));
    ...
    void testCustomSelectorWithParamsWithCache () {
        var named003_std = Implementation.of (NamedService003.class, new CustomSelector (), new StdCustParams ("s"));
        assertTrue (named003_std.isPresent ());
        assertTrue (named003_std.get ().getClass ().getName ().endsWith ("Standard"));
        var named003_std_clone = Implementation.of (NamedService003.class, new CustomSelector (), new StdCustParams ("s"));
        assertSame (named003_std.get (), named003_std_clone.get ());
        
        var named003_cus = Implementation.of (NamedService003.class, new CustomSelector (), new StdCustParams ("c"));
        assertTrue (named003_cus.isPresent ());
        assertTrue (named003_cus.get ().getClass ().getName ().endsWith ("Custom"));
        var named003_cus_clone = Implementation.of (NamedService003.class, new CustomSelector (), new StdCustParams ("c"));
        assertSame (named003_cus.get (), named003_cus_clone.get ());
        
        var named003_no = Implementation.of (NamedService003.class, new CustomSelector (), new StdCustParams ("asd"));
        assertTrue (named003_no.isEmpty ());
    }
